        ...
        <Card className="bg-card/90 backdrop-blur-sm border border-border overflow-hidden relative">
          <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
            ...
            <div className="relative size-32 mb-4">
              ...
              <div className="relative w-full h-full rounded-full bg-card border border-border overflow-hidden">
            ...
            <h2 className="text-xl font-bold text-foreground">Dr.Yong</h2>
            ...
            {messages.map((msg, index) => (
              ...
              >
                <div className="font-semibold text-xs text-muted-foreground mb-1">
                  {msg.role === 'assistant' ? 'Dr.Yong' : 'You'}:
                </div>
            ...
            {callEnded && (
              <div className="message-item animate-in fade-in duration-300">
                ...
                <p className="text-foreground">
                  Call ended. Thank you for using DentalHelp!
                </p>
              </div>
            )}
          </div>
